...
export const DJI_RECORD = {
  ...
  freqMap: [
    ...
    {label: 'dji-ch6', channel: 6, achannel: 7, name: 'Channel 6', freq: 5.876 },
    {label: 'dji-ch7', channel: 7, achannel: 8, name: 'Channel 7', freq: 5.912 }
  ]
};
...
const WALKSNAIL_RECORD = {
  ...
  freqMap: [
    {label: 'walk-ch1', channel: 1, achannel: 1, name: 'Channel 1', freq:5.658 },
    {label: 'walk-ch2', channel: 2, achannel: 2, name: 'Channel 2', freq:5.695 },
    {label: 'walk-ch3', channel: 3, achannel: 3, name: 'Channel 3', freq:5.732 },
    {label: 'walk-ch4', channel: 4, achannel: 4, name: 'Channel 4', freq:5.769 },
    {label: 'walk-ch5', channel: 5, achannel: 5, name: 'Channel 5', freq:5.806 },
    {label: 'walk-ch6', channel: 6, achannel: 7, name: 'Channel 6', freq:5.880 },
    {label: 'walk-ch7', channel: 7, achannel: 8, name: 'Channel 7', freq:5.917 }
  ]
};
